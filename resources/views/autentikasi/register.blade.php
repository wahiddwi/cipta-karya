            ...
            <div class="p-5">
              ...
              <form class="user" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <input type="text" name="name" class="form-control form-control-user @error('name') is-invalid @enderror" id="name" placeholder="Your Full Name" required autocomplete="name" autofocus>
                    @error('name')
                ...
                <div class="form-group">
                  <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror" id="email" name="email" placeholder="Email Address" required autocomplete="email">
                  @error('email')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
